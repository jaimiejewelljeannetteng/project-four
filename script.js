...
app.apiUrlWeather = "https://api.apixu.com/v1/current.json";
...
//error handling, if user does not input correct city
app.incorrectInput = () => {
  Swal.fire({
    title: "Error!",
    text: "City name doesn't exist, please put in correct city name",
    type: "error",
    confirmButtonText: "OK"
  });
};
